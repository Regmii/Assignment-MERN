...
let result = 'year' in car4 && 'model' in car4 && 'make' in car4
console.log(result)
...
const empty = Object.values(book9).includes(null)
console.log(empty)
// Q10: Reverse the 'fullName' property value in the 'person' object.
// Expected output:
// 'doe John'
const person10 = { fullName: 'John doe' };
let answer = person10.fullName.split(' ').reverse().join(' ')
console.log(answer)